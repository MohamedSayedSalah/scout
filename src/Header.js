                ...
                <div className="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                    ...
                    <div className="hidden sm:block sm:ml-6">
                        <div className="flex space-x-4">
                            ...
                            <a href="/jobs"
                               className="bg-gray-900 text-white px-3 py-2 rounded-md text-sm font-medium">Jobs</a>
                            <a href="/jobs/new"
                               className="text-gray-300 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">New Job</a>
                        </div>
                    </div>
                </div>
                <div
